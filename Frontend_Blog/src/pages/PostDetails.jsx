...
const PostDetails = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-5 mt-20 bg-white dark:bg-gray-700 text-black dark:text-white">
      ...
      {/* Content */}
      <div
        className="mt-5 text-lg text-gray-700 dark:text-gray-200"
      ...
      <button
        ...
        disabled={loading}
        className="bg-green-600 text-white px-4 py-2 mt-5 rounded hover:bg-green-700 disabled:bg-gray-500"
      >
        {loading
          ? "Generating..."
          : summary
      ...
      {summary && (
        <button
          onClick={stopSpeech}
          className="bg-red-500 text-white px-4 py-2 mt-3 ml-2 rounded hover:bg-red-600"
        >
          ⏹ Stop
        </button>
      )}
